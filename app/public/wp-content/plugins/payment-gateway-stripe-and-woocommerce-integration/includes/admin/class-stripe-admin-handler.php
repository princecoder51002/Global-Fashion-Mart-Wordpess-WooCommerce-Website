        ...
        <div class="wrap">
            ...
            <div class="eh_settings_left">
                ...
                <a href="?page=wt_stripe_menu&tab=general_settings" class="nav-tab <?php echo $active_tab == 'general_settings' ? 'eh-nav-tab-active stripe' : 'stripe'; ?>"><?php  _e('General Settings','payment-gateway-stripe-and-woocommerce-integration'); ?></a>
                   ...
                   <a href="?page=wt_stripe_menu&tab=alipay" class="nav-tab <?php echo $active_tab == 'alipay' ? 'eh-nav-tab-active stripe' : 'stripe'; ?>"><?php  _e('Alipay','payment-gateway-stripe-and-woocommerce-integration'); ?></a>
                    <a href="?page=wt_stripe_menu&tab=sepa" class="nav-tab <?php echo $active_tab == 'sepa' ? 'eh-nav-tab-active stripe' : 'stripe'; ?>"><?php  _e('SEPA','payment-gateway-stripe-and-woocommerce-integration'); ?></a>
                     <a href="?page=wt_stripe_menu&tab=klarna" class="nav-tab <?php echo $active_tab == 'klarna' ? 'eh-nav-tab-active stripe' : 'klarna'; ?>"><?php  _e('Klarna','payment-gateway-stripe-and-woocommerce-integration'); ?></a>
