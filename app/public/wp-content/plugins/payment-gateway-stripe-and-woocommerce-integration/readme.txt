=== Stripe Payment Gateway for WooCommerce (Debit, Credit Card, Apple Pay, Google Pay, Alipay, Stripe Checkout, SEPA)  ===
...
Accept Credit Cards, Debit Cards, Google Pay, Apple Pay, Alipay, SEPA, and Klarna in your WooCommerce store via the Stripe payment gateway.

== Description ==

### Introduction ###
Stripe Payment Gateway Plugin for WooCommerce lets you accept credit cards/debit cards (Mastercard, Visa, American Express, Discover, JCB, Diners Club), Alipay, Apple Pay, Google Pay, SEPA, and Klarna within your website via the Stripe Payment Gateway.
...
### Major Features of the Stripe Payment Gateway plugin for WooCommerce ###
...
7. Stripe SEPA Pay
8. Stripe Klarna
9. Stripe Overview Page
10. Stripe General Settings
